...
| **Steps** | | **Steps** | <ol><li>User opens the web app.</li><li>User enters a search term, such as the restaurant name, location, or selects a rating filter.</li><li>The system sends a request to the API.</li><li>The web app displays the food hygiene ratings.</li><li>If no results are found, the app displays a message saying, "No results found," and suggests alternative actions.</li></ol> |
