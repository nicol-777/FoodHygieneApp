...
| **Actors** |Users |
|**Assumptions** | The user knows the name, location or rating of the restaurant.| The user is familiar with using web apps and entering search terms. | The user has access to an internet device.
