...
| **Steps** | 1. Business owner opens web app.<br>2.Business owner searches for their food business by name or location.<br>3The system displays their food hygiene rating and other details.<br>4..If the information is incorrect, the business owner uses the chatbot to navigate to the correction form.<br>|
